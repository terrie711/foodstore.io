...
<header>
<blockquote>
	<img src="image/logo-new.png"  width="120" height="auto">
...
if(isset($_SESSION['id'])){
	...
	$sql = "SELECT customer.CustomerName, customer.CustomerIC, customer.CustomerGender, customer.CustomerAddress, customer.CustomerEmail, customer.CustomerPhone, food.FoodTitle, food.Price, food.Image, `order`.`DatePurchase`, `order`.`Quantity`, `order`.`TotalPrice`
...
<?php
	...
	while($row = $result->fetch_assoc()){
    	...
    	echo $row['FoodTitle']."<br>Php".$row['Price']."<br>";
    	echo "Quantity: ".$row['Quantity']."<br>";
    	echo "</td></tr>";
    	$total += $row['TotalPrice'];
	}
	echo "<tr><td style='background-color: #ccc;'></td><td style='text-align: right;background-color: #ccc;''>Total Price: <b>Php".$total."</b></td></tr>";
	echo "</table>";
	echo "</div>";
